...
:: Sensor Node Build & Flash Script using PlatformIO (framework = arduino)
:: Usage:
::   build_and_flash.bat               - Build only (env: yolo_uno)
::   build_and_flash.bat build [PORT]  - Build only
::   build_and_flash.bat flash [PORT]  - Upload to board (default port: COM3)
::   build_and_flash.bat monitor [PORT]- Start serial monitor (default port: COM3)
::   build_and_flash.bat all [PORT]    - Build, upload & monitor (default port: COM3)
...
echo ===================================================
echo [PlatformIO] Project: sensor-node
