...
This reference document details the official **UI Development Pipeline and Standard Operating Procedure (SOP)** for building real-time warning displays using **LVGL v9** on the **ESP32-S3** microcontroller paired with a 7-inch RGB Touch LCD (800x480 resolution).
