...
:: Sensor Node Build & Flash Script using CMake & Ninja (ESP-IDF v6.0.2)
:: Usage:
::   build_and_flash.bat               - Incremental Build & Flash (default port: COM8)
::   build_and_flash.bat build [PORT]  - Incremental Build & Flash (default port: COM8)
::   build_and_flash.bat flash [PORT]  - Flash target directly (default port: COM8)
::   build_and_flash.bat monitor [PORT]- Start serial monitor (default port: COM8)
::   build_and_flash.bat all [PORT]    - Incremental Build, Flash & Monitor (default port: COM8)
::   build_and_flash.bat clean         - Clean build directory

set DEFAULT_PORT=COM8
set ACTION=%~1
...
echo ===================================================
echo [ESP-IDF] Project: sensor-node
